...
<script src="/comz/App/Manage/View/Default/js/common.js" type="text/javascript"></script>
 <script type="text/javascript">
  function clear_del()
  {
   if(confirm("确定要删除数据吗？"))
   {
	subform('/comz/index.php/manage/banner/delall');
   }
  }
 </script>
...
<div class="main">
    ...
    <div class="list">    
    <form action="/comz/index.php/manage/banner/sortcate" method="post" id="form_do" name="form_do">
        <table width="100%">
            <tr>
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr style="height:95px;">
				...
				<td>
				<?php if($v['column_images']): ?><a href="/comz/Uploads/<?php echo ($v["column_images"]); ?>" target="_blank"><img src="/comz/Uploads/<?php echo ($v["column_images"]); ?>" width="150px" height="50px" border="0" /></a>
				<?php else: ?>
				<img src="/comz/App/Manage/View/Default/Images/nopic.jpg" width="150px" height="50px" border="0" /><?php endif; ?>
                ...
                <td>
                    <a href="/comz/index.php/manage/banner/edit/id/<?php echo ($v["id"]); ?>">修改</a>
					
					<?php if($v['column_ifimg']==1): ?><a href="/comz/index.php/manage/banner/ifedit/id/<?php echo ($v["id"]); ?>">关闭</a>
					<?php else: ?>
					<a href="/comz/index.php/manage/banner/ifedit/id/<?php echo ($v["id"]); ?>">开启</a><?php endif; ?>
