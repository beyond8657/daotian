...
<script src="/comz/App/Manage/View/Default/js/common.js" type="text/javascript"></script>
...
<div class="main">
    <div class="operate">
        <div class="left">
                <input type="button" onClick="window.open('/comz/index.php/<?php echo ($module); ?>/Article/add/nav/<?php echo ($nav); ?>','main')" target="main" class="btn_blue" value="添加">
				<input class="btn_blue" type="button" onClick="subform('/comz/index.php/<?php echo ($module); ?>/Article/move')" value="移动" />
	
				<input class="btn_blue" type="button" onClick="return clear_del();" value="删除" />
				
                <input type="button" onClick="window.open('/comz/index.php/<?php echo ($module); ?>/Article/trach','main')" target="main" class="btn_green" value="回收站">
            
        </div>
        <?php if(ACTION_NAME == "index"): ?><div class="left_pad">
            <form method="get" action="/comz/index.php/manage/article/search">
    ...
    <div class="list">   
    <form action="/comz/index.php/<?php echo ($module); ?>/Article/delall" method="post" id="form_do" name="form_do">
        ...
        <table width="100%">
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($v["id"]); ?></td>
                <td class="aleft">
				<a href="/comz/index.php/article/detail/id/<?php echo ($v["id"]); ?>" target="_blank"><?php echo ($v["news_title"]); ?></a>
				...
				<a href="/comz/index.php/<?php echo ($module); ?>/Article/edit/id/<?php echo ($v["id"]); ?>/type/Article">编辑</a>
				<a href="/comz/index.php/manage/article/do_trach/id/<?php echo ($v["id"]); ?>" onClick="return confirm('是否确定删除?')">删除</a>
				</td>
