    ...
    <form action="<?php echo U('Article/delall');?>" method="post" id="form_do" name="form_do">
        ...
        <table width="100%">
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($v["id"]); ?></td>
                <td class="aleft">
				<a href="/comz/index.php/product/detail/id/<?php echo ($v["id"]); ?>" target="_blank"><?php echo ($v["news_title"]); ?></a>
				...
				<a href="/comz/index.php/<?php echo ($module); ?>/Article/edit/id/<?php echo ($v["id"]); ?>/type/Product">编辑</a>
				<a href="/comz/index.php/manage/product/do_trach/id/<?php echo ($v["id"]); ?>" onclick="return confirm('是否确定删除?')">删除</a>
				</td>
