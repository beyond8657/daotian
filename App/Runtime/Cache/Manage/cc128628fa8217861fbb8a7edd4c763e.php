...
<link href="/comz/App/Manage/View/Default/css/frame.css" rel="stylesheet" type="text/css" />
...
<div class="top_logo"></div>
     <div class="nav" id="nav">
      <ul>
		  ...
		  <li id="menu_count1"><a href="<?php echo U('user/index');?>" _for="common1" target="main"><b>用户管理</b></a></li>          
	 ...
	 <div class="top_link">
      <ul>
        ...
        <li id="i_home"><a href="/comz/index.php" target="_blank">首页</a></li> 
        <li id="i_help"><a href="http://www.DTCMS.com/" target="_blank">帮助</a></li>    
        <li id="i_exit"><a href="/comz/index.php/manage/admin/login_out" target="_top">退出</a></li>		
      </ul>
    </div>
</div>
<!-- header end -->
...
<div id="items_banner">
	...
	<dl id="dl_items_1_1">
		...
		<dd>
		<ul>
        <li><a href="/comz/index.php/<?php echo ($module); ?>/Banner/index" target="main">栏目广告</a></li>
...
<dl id="dl_items_1_3">
	...
	<dd>
		<ul>
            ...
            <li><a target="main" href="<?php echo U('System/clearRuntime');?>">清除PC系统缓存</a></li>
            <li><a target="main" href="<?php echo U('System/clearRuntime');?>">清除手机系统缓存</a></li>
		</ul>
	</dd>
</dl>
<!--
...
<dl id="dl_items_3_4">
	...
	<dd>
		<ul>
			...
			<li><a href="<?php echo U('Guestbook/index');?>" target="main">用户留言管理</a></li>		
