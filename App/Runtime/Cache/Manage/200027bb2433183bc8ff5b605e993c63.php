...
<LINK rel=stylesheet type=text/css href="/comz/App/Manage/View/Default/css/login.css">
...
<script type="text/javascript" src="/comz/App/Manage/View/Default/js/jquery-1.7.2.min.js"></script>
<BODY id="login">
<div style="background:#CCCCCC">
<FORM id=loginForm onSubmit="return check(this)" method="post" action="/comz/index.php/manage/login/do_login">
...
<LABEL><SPAN></SPAN><span style="margin-left:70px; margin-top:-10px;"><img src='/comz/index.php/Manage/Verify/code?w=200&h=32' onclick='this.src=this.src+"?"+Math.randon'/></span></LABEL>
...
<a href="http://www.DTCMS.com" target="_blank" style="text-decoration:none;">DTCMS企业网站管理系统  <?php echo (C("setting.Version")); ?></a></P>
</BODY></HTML>