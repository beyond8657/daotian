...
<div class="main">
    ...
    <div class="operate">
        <div class="left">
		<input type="button" onclick="window.open('/comz/index.php/manage/category/add','main')" target="main" class="btn_blue" value="添加栏目">
    ...
    <div class="list">    
    <form action="/comz/index.php/manage/category/sortcate" method="post" id="form_do" name="form_do">
        <table width="100%">
            <tr>
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
				<a href="/comz/index.php/manage/category/add/id/<?php echo ($v["id"]); ?>">添加子栏目</a>

                
                <a href="/comz/index.php/manage/category/edit/id/<?php echo ($v["id"]); ?>">修改</a>
                <a href="/comz/index.php/manage/category/delete/id/<?php echo ($v["id"]); ?>" onclick="return confirm('是否确定删除?')">删除</a>
				</td>
