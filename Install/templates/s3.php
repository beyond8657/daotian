      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="DTCMS" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="tuzi_" class="input" disabled></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个DTCMS时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="DTCMS企业网站管理系统" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="DTCMS,php,企业网站管理系统,cms,椰角网络,yejiao,thinkphp" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="DTCMS（简称TC）是一款基于PHP+MySql开发的企业网站内容管理系统，其中免费版是完全开源的版本，采用MVC设计模式实现业务逻辑与表现层的适当分离，使网页设计师能够轻松设计出理想的模板，框架式开发易用扩展，支持自定义内容模型，可面向中小型站点提供重量级网站建设方案。对于那些想要进行开发，但技术不足的站长们是一个难得的CMS平台。企业建站，就选道田CMS！TC的开发旨在帮助创业者搭建企业网站平台，实现创业梦想。"></td>
